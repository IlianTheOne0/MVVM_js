...
class ViewsHome
{
	...
	updateAuthBlock(isLoggedIn = false)
	{
		...
		if (!anonUser || !loggedUser) { console.warn("Elements for user status not found"); return; }

		if (isLoggedIn) { anonUser.classList.add('hidden'); loggedUser.classList.remove('hidden'); return; }
